...
namespace OpenCvSharp
{
    static partial class NativeMethods
    {
        ...
        [NativeDelegate("ml_Ptr_DTrees_delete")] public static ml_Ptr_DTrees_deleteDelegate ml_Ptr_DTrees_delete;
        
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate IntPtr ml_Ptr_DTrees_getDelegate(IntPtr obj);
        [NativeDelegate("ml_Ptr_DTrees_get")] public static ml_Ptr_DTrees_getDelegate ml_Ptr_DTrees_get;
    }
}
